# This is a simple TODO App built with React.js for the frontend and Node.js for the backend. The app allows users to create, read, update and delete tasks.
## Table of Contents
### Features
### Technologies
### Installation
